...
#ifndef MACOS_UTIL_H
#define MACOS_UTIL_H
#ifdef _COMMON_MACOS_UTIL_H
#error "KPX compat/macos_util.h conflicts with common/include/macos_util.h — both included in same TU"
#endif
#define _KPX_MACOS_UTIL_H
...
#endif // _ROUTINE_DESCRIPTOR_DEFINED
