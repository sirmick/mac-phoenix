...
#ifndef KPX_VIDEO_DEFS_H
#define KPX_VIDEO_DEFS_H
#ifdef _COMMON_VIDEO_DEFS_H
#error "KPX compat/video_defs.h conflicts with common/include/video_defs.h — both included in same TU"
#endif
#define _KPX_VIDEO_DEFS_H

// Block core's video_defs.h from being included after us
#define VIDEO_DEFS_H
