...
/* Define to enable IPC audio driver */
/* #undef ENABLE_IPC_AUDIO */

/* Define to enable IPC video driver */
/* #undef ENABLE_IPC_VIDEO */
...
/* Define if framework Metal is available. */
/* #undef HAVE_FRAMEWORK_METAL */
