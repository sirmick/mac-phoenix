...
echo "  EMULATOR_TIMEOUT=1 CPU_BACKEND=uae ./build/macemu-next --rom test_roms/test_aline_trap.rom --no-webserver"
echo ""
echo "To test with Unicorn:"
echo "  EMULATOR_TIMEOUT=1 CPU_BACKEND=unicorn ./build/macemu-next --rom test_roms/test_aline_trap.rom --no-webserver"