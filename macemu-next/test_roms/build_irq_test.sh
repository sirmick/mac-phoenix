...
echo "========================================"
echo ""
echo "1. Build macemu-next if not already built:"
echo "   ninja -C build"
echo ""
...
echo "   # UAE backend:"
echo "   EMULATOR_TIMEOUT=2 CPU_BACKEND=uae ./build/macemu-next --rom test_roms/${ROM_NAME}.rom --no-webserver"
echo ""
echo "   # Unicorn backend:"
echo "   EMULATOR_TIMEOUT=2 CPU_BACKEND=unicorn ./build/macemu-next --rom test_roms/${ROM_NAME}.rom --no-webserver"
echo ""
