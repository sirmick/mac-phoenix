...
mac-phoenix uses BasiliskII's "direct addressing" mode where Mac virtual addresses map directly to host pointers via a simple offset. This provides excellent performance but requires careful setup.
