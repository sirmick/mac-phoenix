...
The wire protocol (BR_CMD_* / BR_EV_*) is unchanged from the legacy
Firefox/BiDi era — only the host implementation differs. Guest-side
`MacBrowser.bin` works identically against either backend.
